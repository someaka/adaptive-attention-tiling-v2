...
### 1. CPU Vectorization Tests
- [x] Attention Vectorization Tests (`test_vectorization.py`)
  - [x] Batch size variations (32, 64)
...
- [x] Memory Layout Tests (`test_memory_layout.py`)
