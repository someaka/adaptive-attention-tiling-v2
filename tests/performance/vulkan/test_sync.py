...
from src.core.performance.vulkan.sync import VulkanSync, SyncMetrics
...
class TestVulkanSync:
    ...
    def test_fence_performance(self):
        ...
        for count in fence_counts:
            ...
            assert creation_time < 0.001 * count, f"Fence creation too slow"
            assert signal_time < 0.001 * count, f"Fence signaling too slow"
            assert wait_time < 0.001 * count, f"Fence waiting too slow"
    ...
    def test_semaphore_performance(self):
        ...
        for size in self.sizes:
            ...
            assert avg_timeline_time < avg_binary_time * 1.5, "Timeline semaphores should be competitive"
