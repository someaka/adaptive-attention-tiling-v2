...
class CPUOptimizer:
    ...
    def optimize_computation(self,
                           computation_graph: torch.nn.Module,
                           sample_input: torch.Tensor) -> torch.nn.Module:
