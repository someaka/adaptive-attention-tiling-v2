...
class PerformanceAnalyzer:
        ...
        if 'cpu_usage' in metrics:
            ...
            if cpu_usage > self.threshold_cpu:
                bottlenecks.append(PerformanceBottleneck(
                    component='CPU',
                    severity=(cpu_usage - self.threshold_cpu) / (1 - self.threshold_cpu),
    ...
    def analyze_regression(self,
                         ...
                         current: Dict[str, float]) -> List[RegressionResult]:
...
class ReportGenerator:
    ...
    def generate_performance_report(self,
        ...
        for bottleneck in bottlenecks:
            report.append(f'### {bottleneck.component} (Severity: {bottleneck.severity:.1%})')
