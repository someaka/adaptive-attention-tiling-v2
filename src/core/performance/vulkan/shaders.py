...
class ShaderManager:
    ...
    def create_compute_pipeline(
        ...
        descriptor_set_layout_info = vk.DescriptorSetLayoutCreateInfo(bindings=bindings)
        ...
        compute_pipeline_info = vk.ComputePipelineCreateInfo(
            layout=pipeline_layout, stage=shader_stage
        )
...
class ComputeShaderDispatcher:
    ...
    def __init__(
        self, device: vk.Device, queue: vk.Queue, command_pool: vk.CommandPool
    ):
        self.device = device
        self.queue = queue
