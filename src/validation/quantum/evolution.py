...
from ...core.quantum.path_integral import PathIntegral
...
class UnitaryValidator:
    ...
    def validate_unitary(
        ...
        # Compute phase error
        phase_error = self._compute_phase_error(
            initial, evolved, evolution_operator
        )
        
        # Check norm preservation
        norm_preservation = self._check_norm_preservation(
            initial, evolved
        )
...
class DecoherenceValidator:
    ...
    def validate_decoherence(
        ...
        # Track purity loss
        purity_loss = self._compute_purity_loss(
